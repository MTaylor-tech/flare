...
class RulesArticle(models.Model):
    ...
    rules_version = models.CharField(max_length=20, default="3.1.1")
...
class RulesKeyword(models.Model):
    keyword_text = models.CharField(max_length=200)
    articles = models.ManyToManyField(RulesArticle)
